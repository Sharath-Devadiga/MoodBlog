...
export default function LandingPage() {
  ...
  const emotions = [
    { emoji: '😊', name: 'Happy', bg: 'bg-amber-500/20', border: 'border-amber-500/50', glow: 'shadow-amber-500/50' },
    { emoji: '😢', name: 'Sad', bg: 'bg-slate-500/20', border: 'border-slate-500/50', glow: 'shadow-slate-500/50' },
    { emoji: '😡', name: 'Angry', bg: 'bg-red-500/20', border: 'border-red-500/50', glow: 'shadow-red-500/50' },
    { emoji: '🎉', name: 'Excited', bg: 'bg-orange-500/20', border: 'border-orange-500/50', glow: 'shadow-orange-500/50' },
    { emoji: '😌', name: 'Calm', bg: 'bg-emerald-500/20', border: 'border-emerald-500/50', glow: 'shadow-emerald-500/50' },
    { emoji: '😰', name: 'Anxious', bg: 'bg-pink-500/20', border: 'border-pink-500/50', glow: 'shadow-pink-500/50' },
  ];
    ...
    <div className="bg-zinc-950 text-white min-h-screen">
      ...
      <nav className="fixed top-0 w-full z-50 bg-zinc-950/90 backdrop-blur-md border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          >
            <Link href="/signin" className="px-5 py-2 text-sm font-medium hover:text-emerald-400 transition-colors">
              Sign In
            </Link>
            <Link href="/signup" className="px-5 py-2 text-sm font-medium bg-gradient-to-r from-orange-500 to-rose-500 rounded-lg hover:shadow-lg hover:shadow-orange-500/30 transition-all">
              Get Started
            </Link>
          </motion.div>
        </div>
      ...
      <section className="py-20 px-6 bg-gradient-to-b from-zinc-950 to-zinc-900">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-400 mt-4">A complete platform for authentic self-expression</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              <motion.div
                ...
                whileHover={{ y: -10 }}
                className="group relative bg-zinc-900 border border-white/5 rounded-2xl p-8 hover:border-white/20 transition-all"
              >
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-400">Three steps to emotional clarity</p>
          </motion.div>
      ...
      <section className="py-20 px-6">
        <motion.div
          ...
          viewport={{ once: true }}
          className="max-w-4xl mx-auto text-center bg-gradient-to-r from-orange-500/10 via-rose-500/10 to-emerald-500/10 border border-white/10 rounded-3xl p-12 md:p-16"
        >
          ...
          <Link
            href="/signup"
            className="inline-flex items-center gap-2 px-10 py-5 bg-gradient-to-r from-orange-500 to-rose-500 rounded-xl text-lg font-semibold hover:shadow-2xl hover:shadow-orange-500/30 transition-all"
          >
            Create Free Account
